...
const SOUNDS = [
  { id: "jump", duration: 0.4, prompt: STYLE_PREFIX + "a short rising jump blip." },
  { id: "double_jump", duration: 0.45, prompt: STYLE_PREFIX + "a quick two-note ascending double-jump blip, higher pitched than a single jump." },
  { id: "stomp", duration: 0.35, prompt: STYLE_PREFIX + "a squashy descending stomp/pop when landing on an enemy." },
  { id: "coin", duration: 0.4, prompt: STYLE_PREFIX + "a bright two-note coin/dewdrop pickup chime." },
  ...
  { id: "fire", duration: 0.3, prompt: STYLE_PREFIX + "a quick zappy laser/ember-shot blip." },
  ...
  { id: "block_bump", duration: 0.3, prompt: STYLE_PREFIX + "a short hollow wooden thump/bonk for bumping a block from underneath." },
  ...
  { id: "select", duration: 0.25, prompt: STYLE_PREFIX + "a short crisp menu-select confirm click-blip." },
];
